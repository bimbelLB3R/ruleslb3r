...
const AccordianKonsulSmanta = ({ allKonsul }) => {
const konsulSmanta = allKonsul.filter((item, index) => item.sekolah === "SMAN 1 Tanjung");
  const data = [
    {
      judul: "Praktisi 1 - Pak Darman",
      namaMap: konsulSmanta.filter((item) => item.praktisi === "Pak Darman"),
    },
    {
      judul: "Praktisi 2 - Mas Ahmad",
      namaMap: konsulSmanta.filter((item) => item.praktisi === "Mas Ahmad"),
    }
  ];
...
export default AccordianKonsulSmanta;
