...
const ButtonUmum = () => {
  ...
  return (
    ...
    <button onClick={handleClick} className="relative overflow-hidden py-4 px-8 text-purple-800 font-bold bg-gradient-to-b from-orange-400 to-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
      <p className="flex items-center justify-center space-x-4">
      <span>Pilih Program Belajar</span>
      <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
