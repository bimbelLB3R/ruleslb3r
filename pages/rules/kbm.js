          ...
          <table className="mt-12 md:mt-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="text-justify">
                  Permintaan perubahan jam harus memiliki alasan yang jelas dan
                  disepakati oleh seluruh siswa di dalam kelas tersebut (tidak
                  boleh permintaan satu atau beberapa orang saja)
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-justify">
                  Setiap kali belajar, siswa diharapkan membawa buku atau bahan
                  ajar sesuai dengan yang ingin dipelajari. Hal itu disebabkan
                  LB3R tidak menyediakan modul khusus. Namun, jika siswa tidak
                  memiliki bahan belajar, materi akan disesuaikan dengan apa
                  yang dipelajari di sekolahnya.
                </td>
              </tr>
              <tr>
                <td className="align-top">8.</td>
                <td className="text-justify">
                  Karena keterbatasan waktu, maka siswa diberi kesempatan untuk
                  bertanya langsung kepada pengajar LB3R melalui whatsapp.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-justify">
                  Sebelum masuk kelas, siswa wajib mengisi presensi menggunakan
                  QRCODE masing-masing atau secara manual dengan menyebutkan
                  nomor induknya
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-justify">
                  ...
                  siswa di suatu kelas menghendaki adanya penambahan siswa maka
                  diperbolehkan selama tidak menggangu KBM.
                </td>
              </tr>
              <tr>
                <td className="align-top">14.</td>
                <td className="text-justify">
                  LB3R dapat menambah siswa ke kelas tertentu dengan atau tanpa
                  persetujuan kelas tersebut jika kuota masih dibawah 10 siswa.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-justify">
                  Kami akan selalu menghubungi siswa yang tidak masuk les, mohon
                  di respon ya..
                </td>
              </tr>
            </tbody>
