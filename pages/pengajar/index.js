...
export default function Pengajar({ allPengajar,allPost,allPraktisi}) {
  ...
  return (
    <>
      ...
      <Layout>
        <h1 className="font-architects text-center text-[25px] lg:text-[70px] m-[55px] lg:m-[100px] text-gray-200">PENGAJAR/PRAKTISI LB3R</h1>
        <h1 className="font-extrabold text-center text-[30px] md:-mt-[150px] mb-[60px]">PENGAJAR/PRAKTISI LB3R</h1>
        ...
        <div className="flex items-center justify-center  md:p-[50px]">
          <div className="grid md:grid-cols-2  gap-8 w-screen m-5">
            {allPraktisi.map((praktisi,index)=>{
              ...
              return <div key={index} className={`group flex items-center justify-center   h-[300px]   bg-gray-200 hover:bg-orange-300 rounded-2xl transition duration-500`}>
                  <div>
              ...
              <div className="grid grid-col-1 gap-6">
                  <div><p className="text-center font-architects">{praktisi.nama}</p>
                    <p className="text-center font-architects uppercase">{praktisi.job}</p></div>
        ...
        {allPengajar.map((pengajar,index)=>{
          ...
          return (<div key={index} className={`group flex items-center justify-center   h-[300px]   bg-gray-200 hover:bg-orange-300 rounded-2xl transition duration-500`}>
            <div>
              ...
              <div className="grid grid-col-1 gap-6">
                <div><p className="text-center font-architects">{pengajar.nama}</p>
              <p className="text-center font-architects uppercase">{pengajar.mapel}</p></div>
